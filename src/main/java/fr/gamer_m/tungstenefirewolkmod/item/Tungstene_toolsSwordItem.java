...
public class Tungstene_toolsSwordItem extends SwordItem {
	public Tungstene_toolsSwordItem() {
		super(new Tier() {
			public int getUses() {
				return 3072;
			}
		...
		}, 3, -3f, new Item.Properties().tab(TungstenefirewolkmodModTabs.TAB_TUNGSTENEMOD));
	}
}
