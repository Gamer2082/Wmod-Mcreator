...
public abstract class Vanadium_ArmorArmorItem extends ArmorItem {
	public Vanadium_ArmorArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Vanadium_ArmorArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "tungstenefirewolkmod:textures/models/armor/vanadium_armor_layer_1.png";
		}
	}

	public static class Chestplate extends Vanadium_ArmorArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends Vanadium_ArmorArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "tungstenefirewolkmod:textures/models/armor/vanadium_armor_layer_2.png";
		}
	}

	public static class Boots extends Vanadium_ArmorArmorItem {
		public Boots() {
